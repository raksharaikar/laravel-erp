            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3><b>Comparison with structure</b></h3><br>
                            <div class="row">
                                <div class="col-md-6">
                                                                                ...
                                                                                <table class="table ">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        @foreach ($childpart1->childparts as $childpart2)
                                                                                            <tr>
                                                                                                <td>{{ $childpart2->partID }}
                                                                                                </td>
                                                                                                <td>{{ $childpart2->quantity }} 
                                                                                                </td>
                                                                                                @if (count($childpart2->childparts) > 0)
                                                                                              
                                                                                                <td>
                                                                                                    <table class="table mt-3 table-bordered " >
                    
                                                                                                        <tbody>
                                                                                                            @foreach ($childpart2->childparts as $childpart3)
                                                                                                                <tr>
                                                                                                                    <td>{{ $childpart3->partID }}
                                                                                                                    </td>
                                                                                                                    <td>{{ $childpart3->quantity }} 
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            @endforeach
                                                                                                        </tbody>
...
<br><br>
                            <div>
                                <h3><b>Comparison without structure ( quantity accumulated )</b></h3><br>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>Part ID</th>
